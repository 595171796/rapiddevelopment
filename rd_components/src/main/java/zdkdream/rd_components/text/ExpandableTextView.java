...
//        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
        ...
        mButton.setCompoundDrawables(
                null, null, mCollapsed ? mExpandDrawable : mCollapseDrawable, null);
        mButton.setText(mCollapsed ? "更多详情" : "收起");
        if (!mCollapsed) {
            mButton.setPadding(dp2px(getContext(), 40), 0, 0, 0);
        } else {
            mButton.setPadding(dp2px(getContext(), 10), 0, 0, 0);
        }
