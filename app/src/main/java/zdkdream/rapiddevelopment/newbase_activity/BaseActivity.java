...
//            setStatusBar(this);
    ...
    private void setStatusBar(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            activity.getWindow().setStatusBarColor(ContextCompat.getColor(this,R.color.colorPrimary));
     ...
     */
    public void setmTbLiftText(int mTbLiftText) {
        TextView mLiftText = mBaseBinding.toolbar.mainToolbarLtext;
        mLiftText.setVisibility(View.VISIBLE);
        mLiftText.setText(mTbLiftText);
        mLiftText.setOnClickListener(this);
    }
     ...
     * @param mTbTilteText
     */
    public void setmTbTilteText(String mTbTilteText) {
        mBaseBinding.toolbar.mainToolbarTitle.setText(mTbTilteText);
    }
     ...
     * 默认隐藏的
     *
     * @param mTbRightText toolbar 右边显示文字
     */
    public void setmTbRightText(String mTbRightText) {
        TextView mRightText = mBaseBinding.toolbar.mainToolbarRtext;
        mRightText.setText(mTbRightText);
